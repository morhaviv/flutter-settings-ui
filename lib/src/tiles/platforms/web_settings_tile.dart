  ...
  Widget build(BuildContext context) {
    ...
    switch (tileType) {
      ...
      case SettingsTileType.sliderTile:
        ...
        tileTypeWidget = Slider(value: initialValue.toDouble(), min: minValue!.toDouble(), max: maxValue!.toDouble(), divisions: sliderDivisions!, label: initialValue.toString(), onChanged: onToggle);
